import 'package:counterapp1/forgetScreen/forgetscreen.dart';
import 'package:counterapp1/homescreen.dart';
import 'package:counterapp1/signUpScreen/signupscreen.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:counterapp1/constants/constants.dart';
  ...
  onLoginPressed(BuildContext context, name, memail, password) {
    ...
    if (email.contains("@") && email.contains(".com")) {
      ...
      Navigator.pushReplacement(context,
          MaterialPageRoute(builder: (BuildContext context) => MainHomeView()));
    } else {
